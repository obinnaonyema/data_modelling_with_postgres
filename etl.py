...
def process_song_file(cur, filepath):
    '''Read file, transform data and write to database
    cur: cursor
    filepath: path to source file for processing
    '''
    # open song file
...
def process_log_file(cur, filepath):
    ...
    #create a dictionary from time_data and column_labels
    data_dict = dict()
    for label, time_obj in zip(column_labels,time_data):
        data_dict[label]=time_obj
...
def process_data(cur, conn, filepath, func):
    ...
    filepath: path to source file for processing
    func: processing function (read process_song_file() or process_log_file() )
    '''
